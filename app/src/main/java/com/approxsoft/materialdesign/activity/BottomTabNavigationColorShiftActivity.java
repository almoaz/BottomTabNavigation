...
public class BottomTabNavigationColorShiftActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bottom_tab_navigation_color_shift);
    ...
    private void Components() {
        ...
        bottomNavigation.setBackgroundColor(Color.rgb(65,107,147));
        ...
        bottomNavigation.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.icon_recent) {
                    ...
                    TextMessage.setText(item.getTitle());
                    bottomNavigation.setBackgroundColor(Color.rgb(1,135,134));

                    return true;
                } else if (itemId == R.id.icon_nearby) {
                    TextMessage.setText(item.getTitle());
                    bottomNavigation.setBackgroundColor(Color.rgb(188,50,142));
