...
public class BottomTabNavigationIconActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bottom_tab_navigation_icon);
    ...
    private void Components() {
        ...
        bottomNavigation.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.icon_1) {
                    TextMessage.setText(item.getTitle());


                    return true;
                } else if (itemId == R.id.icon_2) {
                    TextMessage.setText(item.getTitle());

                    return true;
                } else if (itemId == R.id.icon_3) {
                    TextMessage.setText(item.getTitle());

                    return true;
                }
                else if (itemId == R.id.icon_4) {
                    TextMessage.setText(item.getTitle());

                    return true;
                } else if (itemId == R.id.icon_5) {
                    TextMessage.setText(item.getTitle());
